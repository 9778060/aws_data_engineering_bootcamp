...
ATHENA_DATABASE = 'mobile_network_db'
BUCKET_NAME = ""
S3_OUTPUT = f's3://{BUCKET_NAME}/query_output/'
...
st.write(f'Displaying the latest data from various metrics. Refreshes every {REFRESH_INTERVAL} seconds.')
