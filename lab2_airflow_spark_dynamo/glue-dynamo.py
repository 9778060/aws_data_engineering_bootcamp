...
def upsert_item(row):
    try:
        ...
        table.update_item(
            ...
            UpdateExpression='SET report_date = :rd, total_listens = :tl, unique_users = :uu, total_listening_time = :tlt, avg_listening_time_per_user = :alt',
        ...
        logging.info(f"Successfully processed record for track_id={track_id}, source_file={source_file}")
