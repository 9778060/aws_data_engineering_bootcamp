...
mysql --local-infile=1 -h rental-apartments-db.cluster-cwlyccuo2ur8.us-east-1.rds.amazonaws.com -P 3306 -u admin -p

security group sg-...; allow inbound traffic on port 3306 from your IP
